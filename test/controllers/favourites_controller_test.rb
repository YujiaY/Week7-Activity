...
class FavouritesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create favourite" do
    assert_difference('Favourite.count') do
      post favourites_url, params: { favourite: { anime: @favourite.anime, movie: @favourite.movie, television_show: @favourite.television_show } }
    end
  ...
  test "should update favourite" do
    patch favourite_url(@favourite), params: { favourite: { anime: @favourite.anime, movie: @favourite.movie, television_show: @favourite.television_show } }
